		...
		<div class="row row-cols-1 row-cols-md-1 offset-md-2">
			<div class="col">
				<div class="card w-75">
					...
					<form action="Category_ProductServlet?cid=<%=cid%>&operation=updateCategory" method="post"
						...
						<div class="card-body">
							...
							<div class="mb-3">
								<label class="form-label"><b>Ảnh danh mục</b></label><input class="form-control" type="file" name="categoryimg">
							</div>
							<div class="mb-3">
								<label class="form-label"><b>Ảnh đã tải:&nbsp;</b></label><%=category.getCategoryImage()%>&emsp;<img
